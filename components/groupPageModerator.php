<div class="flex flex-row items-center justify-between p-2 rounded-lg header-colorscheme">
    ...
    <form method="POST" action="<?= $context ?>/scripts/handleJoinRequest.php" class="flex flex-row gap-2">
        ...
        <button type="submit" name="decline" class="p-1 px-3 text-base font-bold text-center text-white transition-all duration-300 bg-red-400 rounded-full max-h-fit hover:bg-red-500 dark:bg-red-500 dark:hover:bg-red-600">Unmod</button>
        <button type="submit" name="decline" class="p-1 px-3 text-base font-bold text-center text-white transition-all duration-300 bg-red-400 rounded-full max-h-fit hover:bg-red-500 dark:bg-red-500 dark:hover:bg-red-600">Kick</button>
    </form>
</div>